...
import { Rocket, Mail, X, AlertCircle } from "lucide-react";
      ...
      <div className="w-full max-w-md panel-raised">
        ...
        <div className="title-bar">
          <div className="flex items-center gap-2">
            ...
            <span className="font-pixel text-base">RetroShip - Login</span>
          </div>
          <button 
            onClick={() => navigate("/")}
